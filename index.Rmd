...
10. Before computing the average size of coastal MPAs, we will need to filter the data to remove rows with null values in the `REP_AREA` column. Try this code in the `Console`
