...
```{r,out.width="80%",echo=F}
knitr::include_graphics('./figures/mean-median2.png')
```
...
```{r,out.width="80%",echo=F}
knitr::include_graphics('./figures/no-take-area2.png')
```
...
```{r,out.width="80%",echo=F}
knitr::include_graphics('./figures/data4.2.png')
```
...
```{r,out.width="80%",echo=F}
knitr::include_graphics('./figures/data5.1.png')
```
...
The histogram above has log data on the x-axis. The x-axis values can be replaced with multiples of 10 and we do this by running the code to replace the labels
on the x-axis:

```{r}
log10.area <- log(data3$GIS_M_AREA,10)
hist(log10.area, breaks = 50, xaxt = "n", xlab = "x label here", ylab = "y label here", main = "title here")   # Histogram with logarithmic axis
axis(side = 1, at = seq(1, 5), labels = c(10, 100, 1000, 10000, 100000))
```
...
```{r,out.width="80%",echo=F}
knitr::include_graphics('./figures/plots2.png')
```
