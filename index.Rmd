...
barplot(data2$`n()`, ylab="number(No. of areas)",
        names.arg=c("Ia","Ib","II","III","IV","V","VI"), las=3, main="Number of areas for each level of protection")
```
...
```{r, results=F}
barplot(data3$REP_AREA, ylab="Area(Amt. land and water area/km^2)",
        names.arg=c("Ia","Ib","II","III","IV", "NA", "NA","NR" ,"V", "VI"), las=3, main="Area of land and water for each level of protection")
``` 
